...
class ModeloProductoUbicacion
{
	...
	static public function mdlEditarProductoUbicacion($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_ubicacion = :id_ubicacion,posicion=:posicion,actualizado_por=:actualizado_por,fecha_actualizacion=:fecha_actualizacion WHERE id = :id");
