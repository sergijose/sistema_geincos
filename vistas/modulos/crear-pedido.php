                  ...
                  <div class="col-xs-5">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control" id="nuevaArea" name="nuevaArea">
                  ...
                  <div class="col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        if (!$pedido) {
                          echo '<input type="text" class="form-control" id="nuevoPedido" name="nuevoPedido" value="0001" readonly>';
                        } else {
                          ...
                          echo '<input type="text" class="form-control" id="nuevoPedido" name="nuevoPedido" value="' . $numeroConCeros . '" readonly>';
                        }
                        ?>
                      </div>
                    </div>
