     ...
     $.ajax({
     	...
     	url:"ajax/productos-lotes.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	=============================================*/
			/*omitir esta alerta compre se esta realizando compra
          	if(stock == 0){
			  ...
			  */
	          ...
	          '<div class="col-xs-3">'+
	             ...
	             '<input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="1" stock="'+stock+'" nuevoStock="'+(Number(stock) + Number(1))+'" required>'+
...
$(".formularioCompras").on("change", "input.nuevaCantidadProducto", function(){
	...
	var nuevoStock = Number($(this).attr("stock")) + Number($(this).val()); //AUMENTA EL STOCK

	$(this).attr("nuevoStock", nuevoStock);
	/*=============================================
	NO APLICA PORQUE SE ESTA HACIENDO UNA COMPRA
		=============================================*/
/*
...
BOTON EDITAR VENTA
=============================================*/
$(".tablaListadoCompras").on("click", ".btnEditarVenta", function(){
...
BORRAR VENTA
=============================================*/
$(".tablaListadoCompras").on("click", ".btnEliminarVenta", function(){
...
$(".tablaListadoCompras").on("click", ".btnImprimirFactura", function(){
